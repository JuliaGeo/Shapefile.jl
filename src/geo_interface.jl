GeoInterface.coordinates(obj::Point) = T[obj.x, obj.y]
GeoInterface.coordinates(obj::PointM) = T[obj.x, obj.y]
GeoInterface.coordinates(obj::PointZ) = T[obj.x, obj.y, obj.z]
